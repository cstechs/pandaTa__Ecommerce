...
const Footer = () => {
  return (
    ...
    <div className="container-fluid">
        <div className="row">
            <div className="col-md-3">
                <h2>How We Help</h2>
                <ul>
                    <li><Link to="/">Retailers</Link></li>
                    <li><Link to="/">Interiors Designers</Link></li>
                    <li><Link to="/">Product Designers</Link></li>
            ...
            <div className="col-md-3">
                ...
                <ul>
                    ...
                    <li><Link to="/">Become a Buyer</Link></li>
    ...
    <div className="footerBottom">
      &copy; 2020 <Link to="/">PANDA / TA</Link> <Link to="/">Terms & Conditions</Link> <Link to="/">Privacy</Link>
    </div>
    </>
  )
}
