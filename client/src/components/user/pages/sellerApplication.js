                    ...
                    <div className="row">
                      <div className="col-12 mt-3">
                        <p>
                          ...
                          possession of my entire as soul, like these sweet{" "}
                          <br />
                          mornings of spring which I enjoy with my whole heart.
                          I am alone standards.
                        </p>
                        <Link
                      ...
                      <div className="col-12 mt-4">
                        ...
                        <div className="mt-5">
                          <p className="text-center font-14 text-darkpurple mt-5">
                            Dont’s have code? <br /> Generate new code, Enter
                            your Mobile Number
                          </p>
                          <input type="number" className="mt-2" required />
                          <span
            ...
            <>
              ...
              <div className="sellerApplicationBox">
                ...
                <div id="goBackToShopping">
                  <p className="text-center font-14 text-darkpurple mt-5">
                    Thank you for submitting Seller Application. Your
                    application is being reviewed, withing 48 hours. <br /> You
                    will receive and email about the status of your application.
                  </p>
                  <Link
                    to="/product"
                    className="btn btn-darkpurple mt-3 ripple"
                  >
