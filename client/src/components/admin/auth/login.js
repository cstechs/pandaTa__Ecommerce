      ...
      <div className="login">
        <div className="container-fluid">
          <div className="row">
            ...
            <input type="password" name="password" value={password} required onChange={e => setPassword(e.target.value)} placeholder="Password" />
                ...
                <input type="submit" className="ripple button-base" value="Login"/>
                <Link to="/admin/register"><button className="sign">Signup</button></Link>
              </form>
            </div>
          </div>
        </div>
