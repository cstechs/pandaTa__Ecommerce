...
const AddProductBar = () => {
    ...
    const { productName, productQuantity, productPrice, productCategory, productDescription, productImage, productSubCategory } = newProduct;
    const onChange = (e) => setNewProduct({ ...newProduct, [e.target.name]: e.target.value });
    const handleOnUploadFile = (e) => setNewProduct({ ...newProduct, [e.target.name]: e.target.files[0] });
    ...
    const onSubmit = e => {
        e.preventDefault();
        if (productName === '' || productQuantity === '' || productPrice === '' || productCategory === '' || productImage === '' || productDescription === '' || productSubCategory === '' ) {
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="card-box">
                                ...
                                <div className="form-group mb-2">
                                    ...
                                    <input type="number" id="product-unit" className="form-control" name="productQuantity" value={productQuantity} required onChange={onChange} placeholder="e.g : quantity" />
                                </div>
                                <div className="form-group mb-2">
                                    <label htmlFor="product-price">Product Price <span className="text-danger">*</span></label>
                                    <input type="number" id="product-price" className="form-control" name="productPrice" value={productPrice} required onChange={onChange} placeholder="e.g : amount" />
                                </div>
                                <div className="form-group mb-2">
                                    <label htmlFor="product-category">Product Category <span className="text-danger">*</span></label>
                                    <select className="form-control select2" id="product-category" name="productCategory" value={productCategory} required onChange={onCategoryChange}>
                                ...
                                <div className="form-group mb-2">
                                    <label htmlFor="product-subcategory">Product SubCategory <span className="text-danger">*</span></label>
                                    <select  className="form-control select2" id="product-subcategory" name="productSubCategory" value={productSubCategory} required onChange={onChange} >
                        ...
                        <div className="col-lg-6">
                            <div className="card-box">
                                ...
                                <div className="dz-message">
                                    <div {...getRootProps({ className: 'dropzone' })}>
                                        <input {...getInputProps()} name="productImage" onChange={handleOnUploadFile} />
                            ...
                            <div className="text-right mt-2">
                                ...
                                <button type="submit" className="btn btn-success ripple button-base px-5 mr-3">ADD PRODUCT</button>
                            </div>
                        </div>
                    </div>
                </form>
