...
<div className="navbar-custom">
  <div className="container-fluid">
    <ul className="list-unstyled topnav-menu float-right mb-0">
      ...
      <li className="dropdown notification-list topbar-dropdown">
        <span className="nav-link dropdown-tog nav-user mr-0 waves-effect waves-light ripple button-base" data-toggle="dropdown" role="button" aria-haspopup="false" aria-expanded="false" >
          <img
            src={UserImage}
            alt="user-image"
        ...
        <div className="dropdown-menu dropdown-menu-right profile-dropdown ">
          <span className="dropdown-item notify-item ripple button-base" >
            <i className="fe-user" />
            <span>Status : <b className="text-success">online</b></span>
          </span>
          <Link to="/admin/setting" className="dropdown-item notify-item ripple button-base" >
    ...
    <div className="logo-box" id="logoBox">
      ...
      <span className="logo logo-light pl-3">
        ...
        <span className="logo-lg">
          <div className="pand-logo">
            <img src={SmLogo}/> <span id="pandlogo">PANDA /
            TA </span>
          </div>
        </span>
      </span>
    ...
    <ul className="list-unstyled topnav-menu topnav-menu-left m-0">
      <li>
        <button className="button-menu-mobile waves-effect waves-light ripple button-base" onClick={toggle}>
          <i className="fe-menu" />
        </button>
      </li>
      <li>
